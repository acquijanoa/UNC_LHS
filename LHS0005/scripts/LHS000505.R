...
## File: LHS000505.R
## 
## Project: Merge shapefile and produce maps by Age
##
## Description: 
##
...
data$WOMEN_AGE_C4 <- factor(data$WOMEN_AGE_C4, 
                      levels = c("[15,20)","[20,30)","[30,40)","[40,50]"), 
                      ordered = TRUE)
...
p1 <- ggplot(shp_st_mgd) + 
  ...
  facet_wrap(~WOMEN_AGE_C4, ncol = 3) +
  ylim(c(12.9, 16.4)) + 
  xlim(c(-89.25, -83)) +
  ...
  labs(
    title = "Probability of Women Overweight and Obesity in Honduras by group age, 2019\n", 
